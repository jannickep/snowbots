...
private: // private types
	...
	public:
		 ...
		 *///-------------------------------------
		void realloc(const UINT32 newSize);
		 ...
		 *                        needed.
		 *///-------------------------------------
		void assureSize(const UINT32 neededSize);
	...
	public:
		 ...
		 *///-------------------------------------
		const buffer_type* getData() const { return data; }

		//========================================
		/*!\brief Get the data in the buffer.
		 * \return Pointer to the data.
		 *///-------------------------------------
		buffer_type* getData() { return data; }
...
public:
	 ...
	 * \return Always #DataType_Image
	 *///-------------------------------------
	virtual DataType getDataType() const { return DataType_Image; }
