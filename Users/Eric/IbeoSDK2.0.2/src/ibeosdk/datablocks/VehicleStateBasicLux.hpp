...
class VehicleStateBasicLux : public DataBlock {
public:
	enum ErrorFlags {
...
public:
	virtual DataType getDataType() const { return DataType_LuxVehicleStateBasic; }
...
public: // getter
	...
	UINT16 getCurrentYawRate() const { return this->m_currentYawRate; }
...
public: // setter
	...
	void setCurrentYawRate(const UINT16 newCurrentYawRate) { this->m_currentYawRate = newCurrentYawRate; }
