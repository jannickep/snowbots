...
class ScanLux : public DataBlock {
public:
	enum ScannerStatus {
...
public:
	...
	virtual DataType getDataType() const { return DataType_LuxScan; }
...
public: // getter
	...
	// const scanPointLux& (int i  ) { return
	UINT16 getNumberOfScanPoints() const { return m_points.size(); }
...
public: // setter
	...
	void setScanPoint(const int idx, const ScanPointLux& sp)
	{
...
protected:
	...
	bool angleCheck() const;
	bool nbOfPtsCheck(const UINT16 nbScanPts) const;

protected:
	static const UINT16 maxNbOfScanPts = 2646;
