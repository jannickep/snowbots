 ...
 *///-------------------------------------------------------------------
class IbeoDataHeader : public Serializable {
public: // construtor/destructor
	 ...
	 *                               (not the DataBlock).
	 *///-------------------------------------
	IbeoDataHeader(const DataType dataType,
...
public:
	 ...
	 * \param[in, out]  The stream where to find the
...
private: // attributes
	 ...
	 *///-------------------------------------
	DataType m_dataType; // serialized as UINT16
